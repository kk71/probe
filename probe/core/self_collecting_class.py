...
class SelfCollectingFrameworkMeta(type):
...
class SelfCollectingFramework(metaclass=SelfCollectingFrameworkMeta):
    ...
    # 如果一个模块import失败，是否打印错误的trace
    FAIL_PRINT_TRACE: bool = True
    ...
    def collect(cls):
        ...
        for module_dir in module_dirs:
            ...
            try:
                ...
                print(f"!!!FAILED TO IMPORT {py_file_path_for_importing}!!!: {e}")
                if cls.FAIL_PRINT_TRACE:
