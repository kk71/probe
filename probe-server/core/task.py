...
class BaseTask(SelfCollectingFramework):
    ...
    @classmethod
    def generate_task(cls, *args, **kwargs) -> "BaseTask":
        """
    ...
    def serialize_for_firing(self, **kwargs) -> str:
        """输出用于发送任务的数据"""
        return json.dumps(
            self._serialize_for_firing(**kwargs),
            ensure_ascii=False,
            indent=4)
